...
#include <memory>
#include "../../NeuralNetwork_Numbs/paintscene.h"
...
QT_MOC_LITERAL(1, 11, 14), // "beginCalculate"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "paintScene\0beginCalculate\0"
};
...
void paintScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->beginCalculate(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&paintScene::beginCalculate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void paintScene::beginCalculate()
{
